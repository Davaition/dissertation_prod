...
GSPC_Prices = pd.read_csv('SandP500.csv')
GSPC_Prices = GSPC_Prices[['Date', 'Close']]
...
GSPC_Prices['Date'] = GSPC_Prices['Date'].apply(str_to_datetime)

GSPC_Prices.index = GSPC_Prices.pop('Date')
...
windowed_df = df_to_windowed_df(GSPC_Prices,
                                '2018-10-12',
                                '2023-06-08',
                                n=3)
...
plt.title('S&P 500 LSTM Training Forecasted vs Actual Close Values')
...
plt.title('S&P 500 LSTM Validation Forecasted vs Actual Close Values')
...
plt.title('S&P 500 LSTM Testing Forecasted vs Actual Close Values')
...
plt.plot(Train_Convert_Close_Prices['Train_Return'], color= 'red', label= 'Forecasted S&P 500 LSTM Training Data Returns')
plt.plot(Val_Convert_Close_Prices['Val_Return'], color= 'black', label= 'Forecasted S&P 500 LSTM Validation Data Returns')
plt.plot(Test_Convert_Close_Prices['Test_Return'], color= 'blue', label= 'Forecasted S&P 500 LSTM Testing Data Returns')
plt.title('S&P 500 LSTM Forecasted Returns')
plt.legend(loc = 'lower left')
plt.show()

Train_Convert_Close_Prices['Date'] = Train_Convert_Close_Prices.index
Train_Convert_Close_Prices.to_csv('S&P 500 Train Data.csv')
Val_Convert_Close_Prices['Date'] = Val_Convert_Close_Prices.index
Val_Convert_Close_Prices.to_csv('S&P 500 Val Data.csv')
Test_Convert_Close_Prices['Date'] = Test_Convert_Close_Prices.index
Test_Convert_Close_Prices.to_csv('S&P 500 Test Data.csv')

Train_Convert_Close_Prices = pd.read_csv('S&P 500 Train Data.csv')
Train_Convert_Close_Prices = Train_Convert_Close_Prices[['Date', 'Close']]
Train_Convert_Close_Prices = Train_Convert_Close_Prices.dropna()

Val_Convert_Close_Prices = pd.read_csv('S&P 500 Val Data.csv')
Val_Convert_Close_Prices = Val_Convert_Close_Prices[['Date', 'Close']]
Val_Convert_Close_Prices = Val_Convert_Close_Prices.dropna()

Test_Convert_Close_Prices = pd.read_csv('S&P 500 Test Data.csv')
