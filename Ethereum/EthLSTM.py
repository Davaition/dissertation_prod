...
ETH_Prices = pd.read_csv('ETH.csv')
ETH_Prices = ETH_Prices[['Date', 'Close']]
...
ETH_Prices['Date'] = ETH_Prices['Date'].apply(str_to_datetime)

ETH_Prices.index = ETH_Prices.pop('Date')
...
windowed_df = df_to_windowed_df(ETH_Prices,
                                '2018-10-12',
                                '2023-06-08',
                                n=3)
...
plt.title('Ethereum LSTM Training Forecasted vs Actual Close Values')
...
plt.title('Ethereum LSTM Validation Forecasted vs Actual Close Values')
...
plt.title('Ethereum LSTM Testing Forecasted vs Actual Close Values')
...
plt.plot(Train_Convert_Close_Prices['Train_Return'], color= 'red', label= 'Forecasted Ethereum LSTM Training Data Returns')
plt.plot(Val_Convert_Close_Prices['Val_Return'], color= 'black', label= 'Forecasted Ethereum LSTM Validation Data Returns Returns')
plt.plot(Test_Convert_Close_Prices['Test_Return'], color= 'blue', label= 'Forecasted Ethereum LSTM Testing Data returns Returns')
plt.title('Ethereum LSTM Forecasted Returns')
plt.legend(loc = 'lower left')
plt.show()

Train_Convert_Close_Prices['Date'] = Train_Convert_Close_Prices.index
Train_Convert_Close_Prices.to_csv('ETH Train Data.csv')
Val_Convert_Close_Prices['Date'] = Val_Convert_Close_Prices.index
Val_Convert_Close_Prices.to_csv('ETH Val Data.csv')
Test_Convert_Close_Prices['Date'] = Test_Convert_Close_Prices.index
Test_Convert_Close_Prices.to_csv('ETH Test Data.csv')

Train_Convert_Close_Prices = pd.read_csv('ETH Train Data.csv')
Train_Convert_Close_Prices = Train_Convert_Close_Prices[['Date', 'Close']]
Train_Convert_Close_Prices = Train_Convert_Close_Prices.dropna()

Val_Convert_Close_Prices = pd.read_csv('ETH Val Data.csv')
Val_Convert_Close_Prices = Val_Convert_Close_Prices[['Date', 'Close']]
Val_Convert_Close_Prices = Val_Convert_Close_Prices.dropna()

Test_Convert_Close_Prices = pd.read_csv('ETH Test Data.csv')
